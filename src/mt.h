...
typedef float (*FUNC_STAT_PAIR)(const float*, const float*, const int*,const int,const float,const void*);
/********************************************************************************/
/*               multiple testing                                              */
/********************************************************************************/
...
/* N-statistic */
float nstat(const float *Y, const int* L,const int n,
		       const float na,const void *extra); 
float Nstat_num_denum(const float *Y, const int* L,const int n, 
			       const float na,float* num, float* denum,const void* extra);
float Nstat_num_denum_orig(const float *Y, const int* L,const int n, 
			       const float na,float* num, float* denum,const void* extra);
float Nstat_num_denum_qsort(const float *Y, const int* L,const int n, 
			       const float na,float* num, float* denum,const void* extra);
/* super delta sequence stuff */
